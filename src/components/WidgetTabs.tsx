...
export function WidgetTabs() {
  ...
  const [isRenderAsIframeEnabled, setIsRenderAsIframeEnabled] = useState(false)
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <nav className="flex flex-wrap gap-4 items-center justify-center">
            ...
            <ToggleBar
              ...
              disabled={isRenderAsIframeEnabled}
            />
            <ToggleBar
              label="Render as Iframe"
              onToggle={(checked) => setIsRenderAsIframeEnabled(checked)}
            />
          </nav>
        </div>
      </article>
